...
// console.log(findNode("{39cc6abd-eab9-466c-8b32-1536ff901a0a}",model))
const data = [
    {
        "type": "directory",
...
// console.log(treeSearch(model, "{39cc6abd-eab9-466c-8b32-1536ff901a0a}"));
...
// console.log(find(data, "node_modules"));
 ...
 function gN(obj,searched) {
   ...
   function op(obj,searched){
	const res = gN(obj,searched);
	console.log(res)
  return res;
  }

const arrayofkeys=  op(model,'AIM');
